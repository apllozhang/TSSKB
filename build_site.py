...
NEW_COURSES = [
  ...
  dict(id='wlan/stellar-impl-opt', book='sol-stellar-bridge', title='Stellar 桥接与 Multi-Mesh 实施',
       ...
       groups=[
        ('架构与用例', ['sol-bridge-mesh-overview', 'sol-bridge-mesh-usecases']),
  ...
  dict(id='certification/tracks', book='cert-training', title='专业化培训路径 · Certification Tracks',
       subtitle='Training Tracks for Specialisations · 33 页 · 五大方案专业化认证要求与课程序列',
       route=['五大方案专业化的强制认证数量', '各域课程序列', '六行业 ACSR 路径'],
       groups=[
        ('路径', ['cert-paths-specialisations']),
       ]),
  dict(id='certification/offer-network', book='cert-training', title='网络云与行业课程目录',
       subtitle='Training Offer for Network, Cloud & Industries · 69 页 · Sales/Presales/LAN/WLAN/网管全课程表',
       route=['Sales 与 Presales 课程', 'OmniSwitch LAN 课程', 'WLAN 与网管课程', '第三方认证互认（Nokia/Aruba/Versa/Celona）'],
       groups=[
        ('课程目录', ['cert-offer-network']),
        ('第三方互认', ['cert-offer-third-party']),
       ]),
  dict(id='certification/offer-communications', book='cert-training', title='通信云与行业课程目录',
       subtitle='Training Offer for Communications, Cloud & Industries · 47 页 · OXO/OXE/Rainbow/OTCC 全线课程表',
       route=['OXO/OXE 语音课程', 'Rainbow 云协作课程', 'OTCC/ALE Connect/OpenTouch 课程', 'Administrators 与 End-Users 段'],
       groups=[
        ('课程目录', ['cert-offer-communications']),
       ]),
  dict(id='certification/whats-new', book='cert-training', title='培训服务新增内容 · What is New',
       subtitle='Training Services What is New · 12 页 · 2026 年 6 月新增/更新课程速查',
       route=['新增课程 11 条速查'],
       groups=[
        ('动态', ['cert-whats-new']),
       ]),
  ...
  dict(id='solutions/transportation', book='sol-transit', title='轨道交通解决方案 · 设计指南',
       subtitle='两版设计指南 112 页 · 分层架构 / SPB 织构 / 组播 / 容量测算 / 安全纵深 / 产品选型',
       route=['轨交网络需求与分层架构（线路/车站/控制中心）', 'SPB 织构设计与组播', '容量测算（20 站轻轨案例）',
              '安全分区分域与产品选型'],
       groups=[
        ('架构', ['transit-overview', 'transit-architecture']),
        ('织构设计', ['transit-spb-design', 'transit-multicast', 'transit-capacity']),
        ('接入与运维', ['transit-attachment', 'transit-ops']),
        ('安全与选型', ['transit-security', 'transit-products']),
       ]),
...
CATALOG = [
    ...
    ('解决方案 · Solutions', '#4ade80', [
        ...
        ('轨道交通解决方案 · 设计指南', '两版 112 页 · 9 个知识单元 · 分层架构 / SPB 织构 / 容量测算 / 安全纵深 / 产品选型', 'solutions/transportation/index.html'),
    ]),
    ('无线网络 · WLAN', '#a78bfa', [
    ...
    ('认证与学习路径 · Certification', '#fbbf24', [
        ('培训服务体系与培训中心', '培训形式 / 五级认证 / 换证规则 / 14 个培训中心与报名', 'certification/training-system/index.html'),
        ('专业化培训路径 · Certification Tracks', '33 页 · 五大方案专业化认证要求 / 各域课程序列 / 六行业 ACSR 路径', 'certification/tracks/index.html'),
        ('网络云与行业课程目录', '69 页 · Sales / Presales / LAN / WLAN / 网管课程表 + 第三方认证互认', 'certification/offer-network/index.html'),
        ('通信云与行业课程目录', '47 页 · OXO / OXE / Rainbow / OTCC 全线课程表', 'certification/offer-communications/index.html'),
        ('培训服务新增内容 · What is New', '12 页 · 2026 年 6 月新增与更新课程速查', 'certification/whats-new/index.html'),
