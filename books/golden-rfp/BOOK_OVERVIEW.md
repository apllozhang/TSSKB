...
| 单元 | 一句话 | 主要来源 |
|---|---|---|
| grfp-guide | Golden RFP 怎么用：C/PC/NC 分级机制、空白即 NC、"C 必须举证"、选文档选版本地图 | 全部 8 份的 Introduction/Scope |
| grfp-sw-features | AOS 8.10R4 软件特性矩阵精粹：按域抽样 80+ 条标书条目（VC/ERPv2/UNP/SPB/VXLAN/MACsec/PoE…），附机型可用性 | grfp-sw-features |
| grfp-aidc | AI 数据中心需求要点：JCT 由尾延迟决定 → 五条设计铁律；GPU 服务器与 51.2T/25.6T 交换机硬指标 | grfp-aidc |
| grfp-lan-access | 接入交换机硬指标对比表：2260/2360/6360/6465 的端口/PoE/功耗/温度/MTBF 抽样 | grfp-2260/2360/6360/6465 |
| grfp-wlan | Stellar WLAN 精粹：免控制器自组网叙事 + RF 客户端引导五连 + wIDS/wIPS 内置 + AP 分档选型 | grfp-wlan |
| grfp-nms | OmniVista 10.5 精粹：11 章 72 条从订阅到 NAC 的应答素材，内置 RADIUS 不拆卖等话术点 | grfp-ovng |
