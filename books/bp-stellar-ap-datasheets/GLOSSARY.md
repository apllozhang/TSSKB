...
- **AP-MNT-OUT / -H**：室外抱杆壁装/悬挂俯仰套件 <<<PAGE 44>>>
- **PD-9001GR/AT/AC**：1 口 at 千兆 PoE Midspan 30W（不含电源线） <<<PAGE 12>>>
- **POE60U-1BT-X-R**：1 口 bt 万兆 PoE Midspan 60W <<<PAGE 28>>>
- **POEO75U-1BT-X-R**：室外 IP67 单口 10GE bt Midspan <<<PAGE 115>>>
- **ADP-50GRBE/BD**：48V DC 电源适配器（50W/30W） <<<PAGE 12>>>/<<<PAGE 54>>>
- **ANT-O-M2-5/M4-9/M6-8、ANT-S-M6-60-9**：室外双频全向/定向天线（AP1362 用） <<<PAGE 44>>>
- **HLLW**：硬件终身有限保修，全线标配 <<<PAGE 4>>>

## Wi-Fi 标准术语
- **802.11ax / Wi-Fi 6**：OFDMA、MU-MIMO、1024-QAM、BSS Coloring、TWT <<<PAGE 6>>>
- **Wi-Fi 6E**：ax 扩展至 6GHz（5.925-7.125GHz） <<<PAGE 48>>>
- **802.11be / Wi-Fi 7**：MLO、4096-QAM、EHT320、512 Compressed Block Ack、Triggered uplink <<<PAGE 67>>>/<<<PAGE 109>>>
- **MLO（Multi-Link Operation）**：终端跨频段/信道并发收发 <<<PAGE 67>>>
- **EHT20-320**：be 信道宽度档位；6GHz 才支持 320MHz <<<PAGE 69>>>
- **AFC（Automated Frequency Coordination）**：6GHz 标准功率自动频率协调 <<<PAGE 100>>>/<<<PAGE 108>>>
...
- **BLE / Zigbee**：IoT 射频，BT5→5.1→5.4→6.0 随代际升级 <<<PAGE 17>>>/<<<PAGE 120>>>
- **FTM（Fine Timing Measurement, 802.11mc/az）**：精确测距/定位，Wi-Fi 7 代支持 <<<PAGE 80>>>
- **TPM 2.0**：可信平台模块，1331 起标配 <<<PAGE 26>>>
- **MACsec（802.1ae）**：上联口二层加密，AP1511 起支持（1540 双口均支持） <<<PAGE 78>>>/<<<PAGE 98>>>
...
## 安全与管理术语
- **WPA3 Enterprise with CNSA / Personal（SAE）**：企业/个人级 WPA3 <<<PAGE 10>>>
- **OWE / Enhanced Open**：开放网络机会性加密（Wi-Fi 6 早期仅硬件就绪） <<<PAGE 7>>>
- **wIDS/wIPS**：无线入侵检测/防护（需 OmniVista 配合） <<<PAGE 1>>>
- **DPGPSK（Dynamic Private-Group PSK）**：动态私有组预共享密钥（酒店/MDU/住宅） <<<PAGE 67>>>
- **AP cluster / virtual controller**：无控制器集群，主 AP 作虚拟管理器，255 台/集群（1360 系 256） <<<PAGE 2>>>/<<<PAGE 39>>>
- **Wi-Fi Express**：免网管集群模式，Admin/Viewer/GuestOperator 三角色 <<<PAGE 8>>>
- **ZTP（Zero-Touch Provisioning）**：零接触开通 <<<PAGE 8>>>
- **OV2500 / OVT / OVC**：三种网管，AP 管理上限 4K / 5K / 12K-30K <<<PAGE 83>>>
